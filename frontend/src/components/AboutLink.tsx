...
function AboutLink() {
  return (
    <div className="h-[36.91px] w-[289.80px] rounded-4xl flex justify-center items-center text-white
      ...
      <div className="h-[10.91px] w-[89.80px] rounded-4xl flex justify-center items-center text-white
        ...
        <Link to="/about" className="hover:text-[17px] hover:font-semibold transition-all bg-transparent">
          About
        </Link>
      </div>
    </div>
